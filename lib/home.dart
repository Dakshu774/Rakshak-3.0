          ...
          child: NavigationBar(
            ...
            destinations: const [
              NavigationDestination(
                  ...
                  selectedIcon: Icon(LucideIcons.home, color: kBlue500), // Fixed: use color instead of fill
                  label: 'Home'),
              NavigationDestination(
                  icon: Icon(LucideIcons.mapPin),
                  selectedIcon: Icon(LucideIcons.mapPin, color: kBlue500), // Fixed
                  label: 'Location'),
              NavigationDestination(
                  icon: Icon(LucideIcons.calendar),
                  selectedIcon: Icon(LucideIcons.calendar, color: kBlue500), // Fixed
                  label: 'Events'),
              NavigationDestination(
                  icon: Icon(LucideIcons.stethoscope),
                  selectedIcon: Icon(LucideIcons.stethoscope, color: kBlue500), // Fixed
                  label: 'Consult'),
            ],
          ),
        ),
